...
enum Type food_type(Food* foods, int x, int y) {
    ...
    // If the function reaches here, it means no food was found at (x, y)
    // You need to decide what value to return in this case.
    // I'll return a default value, but you may want to handle this differently based on your requirements.
    return None; // Assuming None is a valid value in your Type enum.
}
